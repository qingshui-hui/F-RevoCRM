...
class Products_Edit_Js extends Vtiger_Edit_Js {
    static getMessageForChildProductDeletionOrInActivation(params) {
     ...
     */
    registerEventForMoreCurrencies() {
        var self = this;
     ...
     */
    registerEventForEnableCurrency() {
     ...
     */
    registerEventForEnableBaseCurrency() {
        var container = this.getMoreCurrenciesContainer();
        var thisInstance = this;
