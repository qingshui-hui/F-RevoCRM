...
class Settings_Users_List_Js extends Settings_Vtiger_List_Js {
    static showTransferOwnershipForm() {
    ...
    static registerTransferOwnership() {
    ...
    static triggerDeleteUser(deleteUserUrl, deletePermanently) {
    ...
    static deleteUser(form, deletePermanently) {
    ...
    */
    ...
    static triggerChangePassword(url, module) {
    ...
    static triggerChangeUsername(url) {
