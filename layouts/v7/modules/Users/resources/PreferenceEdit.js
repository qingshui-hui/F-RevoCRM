...
class Settings_Users_PreferenceEdit_Js extends Users_Edit_Js {
    /**
     * Function to register change event for currency separator
     */
    static registerChangeEventForCurrencySeparator() {
    ...
    static registerNameFieldChangeEvent() {
        var form = jQuery('form');
        var specialChars = /[<\>\"\,]/;
