...
class Users_Detail_Js extends Vtiger_Detail_Js {
    ...
    static triggerChangeAccessKey(url) {
     ...
     */
    static triggerDeleteUser(deleteUserUrl) {
    ...
    validateDigitSeparators(e, params) {
