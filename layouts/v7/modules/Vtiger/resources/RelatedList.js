...
class Vtiger_RelatedList_Js {
    ...
    setSelectedTabElement(tabElement) {
    ...
    updateRelatedRecordsCount(relationId) {
    ...
    deleteRelation(relatedIdList, customParams) {
        var aDeferred = jQuery.Deferred();
        var thisInstance = this;
        var params = {};
    ...
    registerScrollForRollupComments() {
