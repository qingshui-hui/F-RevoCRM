...
class Vtiger_Edit_Js extends Vtiger_Index_Js {
    static file = false;
    static editInstance = false;
    static recordPresaveEvent = "Pre.Record.Save";
    static preReferencePopUpOpenEvent = "Vtiger.Referece.Popup.Pre";
    static postReferencePopUpOpenEvent = "Vtiger.Referece.Popup.Post";
    static referenceSelectionEvent = "Vtiger.Reference.Selection";
    static postReferenceSelectionEvent = "Vtiger.PostReference.Selection";
    static postReferenceQuickCreateSave = "Vtiger.PostReference.QuickCreateSave";
    static refrenceMultiSelectionEvent = "Vtiger.MultiReference.Selection";
    static postReferenceQuickCreateSaveEvent = "Vtiger.PostReferenceQuickCreate.Save";
    static popupSelectionEvent = "Vtiger.Reference.Popup.Selection";
    static referenceDeSelectionEvent = "Vtiger.Reference.Deselection";
    ...
    */
    ...
    setEditViewContainer(container) {
    ...
    */
    registerPreventingEnterSubmitEvent(container) {
    ...
    registerFileElementChangeEvent(container) {
    ...
    registerDateAndTimeFieldChangeEvent(container) {
