...
class Vtiger_SearchList_Js extends Vtiger_Class_Js {
    static intializeListInstances(container) {
...
class Vtiger_ModuleList_Js extends Vtiger_List_Js {
    searchModule = false;
    ...
    getDefaultParams() {
        ...
        var parentDefaultParams = super.getDefaultParams();
