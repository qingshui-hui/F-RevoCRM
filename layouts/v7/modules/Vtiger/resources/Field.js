...
class Vtiger_Field_Js {
     ...
     */
    static getInstance(data, moduleName) {
     ...
     */
    addValidationToElement(element) {
...
class Vtiger_Reference_Field_Js extends Vtiger_Field_Js {
    getReferenceModules() {
...
class Vtiger_Picklist_Field_Js extends Vtiger_Field_Js {
    /**
...
class Vtiger_Documentsfolder_Field_Js extends Vtiger_Field_Js {
    /**
     * Function to get the pick list values
     * @return <object> key value pair of options
     */
...
class Vtiger_Currencylist_Field_Js extends Vtiger_Field_Js {
    /**
     * Function to get the pick list values
     * @return <object> key value pair of options
     */
...
class Vtiger_Multipicklist_Field_Js extends Vtiger_Field_Js {
    /**
     * Function to get the pick list values
     * @return <object> key value pair of options
     */
...
class Vtiger_Date_Field_Js extends Vtiger_Field_Js {
    /**
...
class Vtiger_Currency_Field_Js extends Vtiger_Field_Js {
    /**
...
class Vtiger_Owner_Field_Js extends Vtiger_Field_Js {
    /**
...
class Vtiger_Datetime_Field_Js extends Vtiger_Date_Field_Js {};

class Vtiger_Time_Field_Js extends Vtiger_Field_Js {
    /**
     * Function to get the user date format
     */
    getTimeFormat() {
...
class Vtiger_Recurrence_Field_Js extends Vtiger_Field_Js {
    /**
     * Function to get the pick list values
     * @return <object> key value pair of options
     */
...
class Vtiger_Email_Field_Js extends Vtiger_Field_Js {
    /**
...
class Vtiger_Image_Field_Js extends Vtiger_Field_Js {
    /**
...
class Vtiger_Integer_Field_Js extends Vtiger_Field_Js {
    getUi() {
        var html = '<input class="inputElement" type="text" name="'+ this.getName() +'" data-label="'+this.get('label')+'" data-rule-'+this.getType()+'=true />';
        html = jQuery(html).val(app.htmlDecode(this.getValue()));
        return this.addValidationToElement(html);
