...
class Vtiger_Pagination_Js extends Vtiger_Class_Js {
    ...
    registerNextPageButtonClickEvent() {
        var thisInstance = this;
    ...
    registerPreviousPageButtonClickEvent() {
        var thisInstance = this;
    ...
    registerNumOfRecordsButtonClickEvent() {
        var thisInstance = this;
    ...
    checkPositiveNumber(currentEle) {
    ...
    registerPageJumpSubmitButtonClickEvent() {
        var thisInstance = this;
