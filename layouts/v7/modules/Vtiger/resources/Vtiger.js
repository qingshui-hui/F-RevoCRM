 ...
 * All Rights Reserved.
 *************************************************************************************/
class Vtiger_Index_Js extends Vtiger_Class_Js {
    static files = [];
    static hideNC = true;
     ...
     */
    static showEmailPreview(recordId, parentId) {
    ...
    static showComposeEmailPopup(params, cb) {
    ...
    static showRecipientPreferences(module) {
        var params = {
            module: module,
     ...
     */
    static registerActivityReminder() {
     ...
     */
    static showReminderPopup(record) {
        var notifyParams = {
    ...
    registerListEssentialsToggleEvent() {
    ...
    registerEventForTaskManagement() {
     ...
     */
    quickCreateGoToFullForm(form, editViewUrl) {
     ...
     */
    registerQuickcreateTabEvents(form) {
        var thisInstance = this;
     ...
     * @returns {undefined}
     */
    quickCreateSave(form, invokeParams) {
        var params = {
     ...
     * @returns {unresolved}
     */
    getQuickCreateForm(url, moduleName, params) {
...
//			});
     ...
     */
    registerAutoCompleteFields(container) {
        var thisInstance = this;
     ...
     */
    registerClearReferenceSelectionEvent(container) {
     ...
     */
    registerReferenceCreate(container) {
        var thisInstance = this;
     ...
     * @param <jQuery> container
     */
    referenceModulePopupRegisterEvent(container) {
        var thisInstance = this;
...
//
     ...
     * @returns {unresolved}
     */
    getMaxiumFileUploadingSize(container) {
     ...
     */
    convertFileSizeInToDisplayFormat(fileSizeInBytes) {
        var i = -1;
     ...
     * @returns {undefined}
     */
    registerHoverEventOnAttachment() {
     ...
     */
    getReferencedModuleName(parentElement) {
     ...
     */
    referenceCreateHandler(container) {
        var thisInstance = this;
    ...
    registerNavigationEvents(container) {
    ...
    _showInventoryQuickPreviewForId(recordId, moduleName, templateId, isReference, mode) {
        var thisInstance = this;
        var params = {};
    ...
    _showQuickPreviewForId(recordId, moduleName, appName, isReference) {
        var self = this;
        var params = {};
        if (typeof moduleName === 'undefined') {
            moduleName = app.module();
    ...
    isInventoryModule(moduleName) {
        var inventoryModules = jQuery('#inventoryModules').val();
        return inventoryModules.indexOf(moduleName) !== -1;
    }

    showQuickPreviewForId(recordId, moduleName, appName, templateId, isReference, mode) {
        var self = this;
    ...
    registerPostReferenceEvent(container) {
        var thisInstance = this;
    ...
    postRefrenceComplete(data, container) {
        var thisInstance = this;
        if(!data)
            return ;
    ...
    getRelatedFieldElements(container, autoFillData) {
        var parentElems = {};
        if (autoFillData) {
    ...
    fillReferenceFieldValue(data, container) {
        var thisInstance = this;
    ...
    confirmAndFillDetails(container, data, message) {
        var thisInstance = this;
    ...
    postRefrenceSearch(resultData, container) {
        var thisInstance = this;
        var module;
