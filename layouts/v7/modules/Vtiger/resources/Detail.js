...
class Vtiger_Detail_Js extends Vtiger_Class_Js {
    static detailInstance = false;
    static PreAjaxSaveEvent = 'PreAjaxSaveEvent';
    static PostAjaxSaveEvent = 'PostAjaxSaveEvent';
    ...
    static triggerSendSms(detailActionUrl, module) {
        var self = this.getInstance();
        self.sendSMS(detailActionUrl,module);
    }

    static deleteRelatedActivity(e) {
    ...
    static deleteActivityRelation(customParams) {
        var params = {
     ...
     * @returns {undefined}
     */
    static transferOwnershipSave(form) {
     ...
     */
    static triggerSendEmail(detailActionUrl, module) {
    ...
    registerOverlayEditEvents(module, container) {
    ...
    setContentHolder(container) {
        this.detailViewContentHolder = container;
    }

    overlayMode = false;

    setOverlayDetailMode(option) {
        this.overlayMode = option;
    }

    getOverlayDetailMode() {
        return this.overlayMode;
    }

    registerRelatedRecordSave() {
        var thisInstance = this;
    ...
    setDetailViewContainer(container) {
     ...
     */
    loadRelatedListRecords(urlParams) {
        var self = this;
    ...
    sendSMS(detailActionUrl, module) {
        var self = this;
    ...
    sendSMSAction(detailActionUrl, callBackFunction) {
        var self = this;
    ...
    deSelectAllrelatedTabs() {
        this.getRelatedTabs().removeClass('active');
    }

    markRelatedTabAsSelected(tabElement) {
    ...
    loadSelectedTabContents(tabElement, urlAttributes) {
            var self = this;
            var detailViewContainer = this.getDetailViewContainer();
    ...
    registerRollupCommentsSwitchEvent() {
        var self = this;
    ...
    registerEventForEmailsRelatedRecord() {
        var detailContentsHolder = this.getContentHolder();
    ...
    */
     ...
     * @returns {undefined}
     */
    registerRelatedListPageNavigationEvents() {
        var thisInstance = this;
        var detailViewContainer = thisInstance.getDetailViewContainer();
        var urlParams = {};
     ...
     */
    registerEventForSelectingRelatedRecord() {
        var thisInstance = this;
        var detailViewContainer = thisInstance.getDetailViewContainer();
    ...
    getRelatedController(relatedModuleName) {
        var thisInstance = this;
     ...
     * @returns {unresolved}
     */
    saveFieldValues(fieldDetailList) {
        var aDeferred = jQuery.Deferred();
    ...
    registerSaveOnEnterEvent(editElement) {
     ...
     * @returns {undefined}
     */
    ajaxEditHandling(currentTdElement) {
        var thisInstance = this;
    ...
    getDependentSourcePicklistName(fieldName) {
     ...
     * @returns {undefined}
     */
    registerAjaxEditSaveEvent(contentHolder) {
        var thisInstance = this;
    ...
    handlePickListDependencyMap(sourcePicklistName) {
        var container = this.getForm();
        var picklistDependcyElemnt = jQuery('[name="picklistDependency"]',container);
        if(picklistDependcyElemnt.length <= 0) {
            return;
     ...
     * @returns {undefined}
     */
    registerAjaxEditCancelEvent(contentHolder) {
        var thisInstance = this;
        if(typeof contentHolder === 'undefined') {
            contentHolder = this.getContentHolder();
        }
    ...
    registerClearReferenceSelectionEvent(contentHolder) {
        var thisInstance = this;
        if(typeof contentHolder === 'undefined') {
            contentHolder = this.getContentHolder();
        }
    ...
    registerBlockStatusCheckOnLoad() {
    ...
    addRelationBetweenRecords(relatedModule, relatedModuleRecordId) {
        var aDeferred = jQuery.Deferred();
        var thisInstance = this;
    ...
    getRelatedRecordsCount(recordId, moduleName) {
        var aDeferred = jQuery.Deferred();
        var params = {
            'type' : 'GET',
            'data' : {
    ...
    removeDeletedTagsFromSummaryTag(deletedTags) {
    ...
    postTagDeleteActions(deletedTagClone) {
        var summaryTagContainer = jQuery('.detailTagList');
    ...
    registerEventToReloadRelatedListOnCloseOverlay(parentId) {
        var self = this;
    ...
    loadRelatedListOfParent(parentRecordId) {
        var self = this;
        var relatedController = self.getRelatedController();
    ...
    registerHeaderAjaxEditEvents(contentHolder) {
        var self = this;
