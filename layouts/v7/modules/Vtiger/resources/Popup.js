...
class Vtiger_Popup_Js {
    ...
    showPopup(params, eventToTrigger, callback) {
     ...
     */
    registerEventForPopupListSearch() {
        var thisInstance = this;
...
//						}
    ...
    registerEventForSelectAllInCurrentPage() {
        var thisInstance = this;
        var popupPageContentsContainer = this.getPopupPageContainer();
    ...
    registerToRemoveEmailFieldClickAttr() {
