...
class Vtiger_DashBoard_Js extends Vtiger_Class_Js {
    static gridster = false;

    //static property which will store the instance of dashboard
    static currentInstance = false;

    static dashboardTabsLimit = 10;

    static addWidget(element, url) {
    ...
    static addMiniListWidget(element, url) {
    ...
    static addNoteBookWidget(element, url) {
        // 1. Show popup window for selection (module, filter, fields)
        // 2. Compute the dynamic mini-list widget url
        // 3. Add widget with URL to the page.
    ...
    getWidgetInstance(widgetContainer) {
    ...
    getWaitingForResizeCompleteMsg() {
