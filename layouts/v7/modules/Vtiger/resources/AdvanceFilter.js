...
class Vtiger_AdvanceFilter_Js {
    ...
    changeFieldElementsView(elementsContainer) {
     ...
     */
    initializeOperationMappingDetails() {
     ...
     */
    setFilterContainer(element) {
        this.filterContainer = element;
        return this;
    }

    getDateSpecificConditionInfo() {
     ...
     */
    getConditionListFromType(fieldType) {
     ...
     */
    addValidationToFieldIfNeeded(selectFieldElement) {
     ...
     */
    isFieldSupportsValidation(fieldSelect) {
        var selectedOption = fieldSelect.find('option:selected');
...
class AdvanceFilter_Field_Js extends Vtiger_Field_Js {
...
class AdvanceFilter_Currencylist_Field_Js extends Vtiger_Currencylist_Field_Js {
    /**
...
class AdvanceFilter_Picklist_Field_Js extends Vtiger_Picklist_Field_Js {
    /**
...
class AdvanceFilter_Multipicklist_Field_Js extends Vtiger_Multipicklist_Field_Js {
    /**
    * Function to get the picklist values
    */
    getPickListValues() {
...
class AdvanceFilter_Owner_Field_Js extends Vtiger_Owner_Field_Js {
    getUi() {
        var comparatorSelectedOptionVal = this.get('comparatorElementVal');
        if(comparatorSelectedOptionVal == 'e' || comparatorSelectedOptionVal =='n'){
...
class Vtiger_Ownergroup_Field_Js extends Vtiger_Owner_Field_Js {
    getUi() {
...
class AdvanceFilter_Date_Field_Js extends Vtiger_Date_Field_Js {
    /**
     * Function to get the ui
...
class AdvanceFilter_Datetime_Field_Js extends AdvanceFilter_Date_Field_Js {};