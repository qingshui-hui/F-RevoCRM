...
class Campaigns_RelatedList_Js extends Vtiger_RelatedList_Js {
    static triggerSendEmail(massActionUrl, module) {
    ...
    loadRelatedList(params) {
        ...
        var self = this;
        super.loadRelatedList(params).then(function(data) {
            self.registerEvents();
    ...
    registerPostSelectionRelatedListActions() {
    ...
    markSelectedIdsCheckboxes(params) {
        var self = this;
    ...
    postLoadRelatedListViewRecords() {
