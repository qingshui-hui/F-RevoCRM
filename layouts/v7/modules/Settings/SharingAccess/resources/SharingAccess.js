 ...
 * All Rights Reserved.
 *************************************************************************************/
class Settings_Sharing_Access_Js extends Vtiger_Class_Js {
    contentTable = false;
    ...
    getCustomRuleContainerClassName(parentModuleName) {
        return parentModuleName+'CustomRuleList';
    }

    showCustomRulesNextToElement(parentElement, rulesListElement) {
     ...
     */
    loadCustomRulesList(moduleName) {
        var thisInstance = this;
     ...
     */
    displaySaveCustomRuleResponse(data) {
     ...
     */
    deleteCustomRule(deleteElement) {
