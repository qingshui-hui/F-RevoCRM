 ...
 * All Rights Reserved.
 *************************************************************************************/
class Settings_PickListDependency_Js extends Vtiger_Class_Js {
    //holds the picklist dependency instance
    static pickListDependencyInstance = false;
     ...
     */
    static triggerEdit(event, module, sourceField, targetField) {
        event.stopPropagation();
        var instance = Settings_PickListDependency_Js.pickListDependencyInstance;
        instance.updatedSourceValues = [];
     ...
     */
    static triggerDelete(event, module, sourceField, targetField) {
        event.stopPropagation();
     ...
     */
    registerPicklistFieldsChangeEvent(form) {
        var thisInstance = this;
     ...
     */
    checkValuesForDependencyGraph(form) {
        var thisInstance = this;
     ...
     *			targetFieldValue - target picklist value
     */
    addNewDependencyPickList(sourceModule, sourceFieldValue, targetFieldValue) {
        var thisInstance = this;
     ...
     */
    registerCancelButtonClickEvent(container) {
        var thisInstance = this;
     ...
     */
    registerTargetFieldsClickEvent(dependencyGraph) {
        var thisInstance = this;
        thisInstance.updatedSourceValues = [];
     ...
     */
    updateValueMapping(dependencyGraph) {
        var thisInstance = this;
     ...
     */
    registerSelectAllSourceValuesClick(dependencyGraph) {
        var thisInstance = this;
     ...
     */
    registerUnSelectAllSourceValuesClick(dependencyGraph) {
        var thisInstance = this;
     ...
     */
    updatedSourceValuesListUpdation(dependencyGraph) {
        var thisInstance = this;
        var dependencyTable = dependencyGraph.find('.pickListDependencyTable');
     ...
     */
    loadMappingForSelectedValues(dependencyGraph) {
        var thisInstance = this;
     ...
     */
    loadListViewContents(forModule) {
        var thisInstance = this;
        app.helper.showProgress();
        var params = {};
        params['module'] = app.getModuleName();
     ...
     */
    registerSourceModuleChangeEvent() {
        var thisInstance = this;
        var container = jQuery('.settingsPageDiv div');
...
class Settings_PickListDependency_List_Js extends Settings_PickListDependency_Js {};
class Settings_PickListDependency_Edit_Js extends Settings_PickListDependency_Js {};