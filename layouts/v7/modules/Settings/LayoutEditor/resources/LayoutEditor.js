...
class Settings_LayoutEditor_Js extends Vtiger_Class_Js {
     ...
     */
    createUpdatedBlocksList(currentField) {
        var thisInstance = this;
     ...
     */
    registerFieldSequenceSaveClick() {
        var thisInstance = this;
        var layout = jQuery('#detailViewLayout');
    ...
    registerHeaderSummaryDependency(container, fieldContainer) {
        var thisInstance = this;
    ...
    showFieldEditModel(data, blockId, fieldContainer) {
        var thisInstance = this;
     ...
     * @param {*} form 
     */
    registerRelationFieldValidationEvent(form) {
     ...
     */
    registerFieldTypeChangeEvent(form, nameAttrsList) {
     ...
     */
    updateNewSequenceForBlocks(sequenceList) {
        var contents = jQuery('#layoutEditorContainer').find('.contents');
     ...
     */
    appendNewBlockToBlocksList(result, form) {
        var contents = jQuery('#layoutEditorContainer').find('.contents');
     ...
     */
    removeBlockFromBlocksList(blockId) {
        var contents = jQuery('#layoutEditorContainer').find('.contents');
        var hiddenAddBlockModel = contents.find('.addBlockModal');
        var blocksListSelect = hiddenAddBlockModel.find('[name="beforeBlockId"]');
     ...
     */
    createReactivateFieldslist(blockId, form) {
        var thisInstance = this;
     ...
     */
    reActivateHiddenFields(currentBlock) {
        var thisInstance = this;
        app.helper.showProgress();
     ...
     */
    registerDeleteCustomBlockEvent() {
        var thisInstance = this;
        var contents = jQuery('#layoutEditorContainer').find('.contents');
        var table = contents.find('.editFieldsTable');
     ...
     */
    registerDeleteCustomFieldEvent(contents) {
        var thisInstance = this;
     ...
     */
    registerFieldDetailsChange(contents) {
        if (typeof contents == 'undefined') {
            contents = jQuery('#layoutEditorContainer').find('.contents');
        }
     ...
     */
    triggerRelatedModulesTabClickEvent() {
        var thisInstance = this;
        var contents = jQuery('#layoutEditorContainer').find('.contents');
     ...
     */
    showRelatedTabModulesList(relatedContainer, extraParams) {
        var thisInstance = this;
    ...
    registerEditFieldDetailsClick(contents) {
        var thisInstance = this;
        if (typeof contents == 'undefined') {
            contents = jQuery('#layoutEditorContainer').find('.contents');
        }
     ...
     */
    addClickOutSideEvent(element, callbackFunction) {
     ...
     */
    registerSwitchActionOnFieldProperties() {
        var thisInstance = this;
        var contents = jQuery('#layoutEditorContainer').find('.contents');
     ...
     */
    disableOrEnableRealtionFieldTabLabels(container) {
    ...
    triggerDuplicationTabClickEvent() {
        var thisInstance = this;
        var contents = jQuery('#layoutEditorContainer').find('.contents');
