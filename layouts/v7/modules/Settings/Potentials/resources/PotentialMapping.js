...
class Settings_PotentialMapping_Js {
    /**
     * Function to register event to edit Potentials mapping
     */
    static triggerEdit(editUrl) {
     ...
     */
    registerOnChangeEventOfTargetModule() {
        var form = jQuery('#potentialsMapping');
