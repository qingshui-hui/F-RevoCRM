...
class Settings_Webforms_List_Js extends Settings_Vtiger_List_Js {
    /**
     * Function to hadle showform
     * @params: show form url
     */
    static showForm(event, record) {
        var self = this;
    ...
    static registerCopyToClipboard() {
     ...
     */
    static getCaptchaCode(showFormContents) {
     ...
     */
    DeleteRecord(deleteRecordActionUrl) {
