...
class Settings_Webforms_Edit_Js extends Settings_Vtiger_Edit_Js {
     ...
     */
    setTargetModule(targetModuleName) {
     ...
     */
    displaySelectedField(selectedField) {
        var editViewForm = this.getForm();
     ...
     */
    registerOnChangeEventForSelect2() {
     ...
     */
    registerEventForMarkRequiredField() {
        var thisInstance = this;
     ...
     */
    registerEventForRemoveTargetModuleField() {
        var thisInstance = this;
     ...
     */
    lockMandatoryOptionInSelect2(mandatoryFieldLabel) {
        var sourceModuleContainer = this.getSourceModuleFieldTable();
     ...
     */
    triggerLockMandatoryFieldOptions() {
        var editViewForm = this.getForm();
     ...
     */
    registerEventToHandleChangeofTargetModule() {
        var thisInstance =this;
        var editViewForm = this.getForm();
     ...
     */
    registerAddFileFieldEvent(form) {
        var self = this;
     ...
     */
    registerFileFieldRemoveEvent(container) {
     ...
     */
    registerEventToHandleOnChangeOfOverrideValue() {
        var thisInstance = this;
     ...
     */
    registerEventForFieldsSaveOrder() {
        var thisInstance = this;
     ...
     */
    registerUsersListMandatoryOnRoundrobinChecked() {
     ...
     */
    eventToHandleChangesForReferenceFields() {
        var thisInstance = this;
        var editViewForm = this.getForm();
    ...
    appendPopupReferenceModuleName(element) {
