 ...
 * All Rights Reserved.
 *************************************************************************************/
class Webforms_Field_Js extends Vtiger_Field_Js {}

class Webforms_Multipicklist_Field_Js extends Vtiger_Field_Js {
    /**
...
class Webforms_Picklist_Field_Js extends Vtiger_Field_Js {
    /**
     * Function to get the pick list values
     * @return <object> key value pair of options
     */
...
class Webforms_Date_Field_Js extends Vtiger_Field_Js {
    /**
...
class Webforms_Currency_Field_Js extends Vtiger_Field_Js {
    /**
...
class Webforms_Time_Field_Js extends Vtiger_Field_Js {
    /**
     * Function to get the ui
     * @return - input text field
     */
...
class Webforms_Reference_Field_Js extends Vtiger_Field_Js {
    getReferenceModules() {
...
class Webforms_Image_Field_Js extends Vtiger_Field_Js {
    /**
     * Function to get the ui
     * @return - input text field
     */
