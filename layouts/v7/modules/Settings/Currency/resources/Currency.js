 ...
 * All Rights Reserved.
 *************************************************************************************/
class Settings_Currency_Js extends Vtiger_Class_Js {
    //holds the currency instance
    static currencyInstance = false;
     ...
     */
    registerCurrencyStatusChangeEvent(form) {
     ...
     */
    registerCurrencyNameChangeEvent(form) {
     ...
     */
    deleteCurrency(id, transferCurrencyEle, currentTrEle) {
