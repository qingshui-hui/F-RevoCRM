...
class Settings_SMSNotifier_List_Js extends Settings_Vtiger_List_Js {
    /**
     * Function to trigger edit and add new configuration for SMS server
     */
    static triggerEdit(event, url) {
     ...
     */
    static triggerDelete(event, url) {
        event.stopPropagation();
        var instance = Vtiger_List_Js.getInstance();
     ...
     */
    registerProviderTypeChangeEvent(form) {
            var thisInstance = this;
     ...
     */
    registerSaveConfiguration(form) {
        var thisInstance = this;
