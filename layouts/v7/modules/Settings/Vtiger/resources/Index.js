...
class Settings_Vtiger_Index_Js extends Vtiger_Index_Js {
    static showMessage(customParams) {
        var params = {};
    ...
    registerAddShortcutDragDropEvent() {
        var thisInstance = this;
    ...
    registerEventForShowOrHideSettingsLinks() {
