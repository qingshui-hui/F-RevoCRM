...
class Settings_Vtiger_OutgoingServer_Js extends Vtiger_Class_Js {
    ...
    registerOnChangeEventOfserverType(e) {
        var form = jQuery('#OutgoingServerForm');
...
class Settings_Vtiger_OutgoingServerEdit_Js extends Settings_Vtiger_OutgoingServer_Js {};

class Settings_Vtiger_OutgoingServerDetail_Js extends Settings_Vtiger_OutgoingServer_Js {};
