...
class Settings_Vtiger_TaxIndex_Js extends Vtiger_Class_Js {
    static updateSelectElement(selectedRegions, skippedRegions, regionsElement) {
     ...
     */
    saveTaxDetails(form, currentTrElement) {
        var thisInstance = this;
     ...
     */
    updateTaxDetails(data, currentTrElement) {
    ...
    editCharge(url, currentTrElement) {
        var aDeferred = jQuery.Deferred();
        var thisInstance = this;
    ...
    saveChargeDetails(form, currentTrElement) {
        var thisInstance = this;
        var params = form.serializeFormData();
        if(typeof params == 'undefined' ) {
            params = {};
    ...
    checkDuplicateChargeName(details) {
        var aDeferred = jQuery.Deferred();
        var params = {
    ...
    registerUpdateRegionsElementEvent() {
    ...
    deleteRegion(url, currentElement) {
    ...
    editRegion(url, currentTrElement) {
        var aDeferred = jQuery.Deferred();
        var thisInstance = this;
    ...
    saveRegionDetails(form, currentTrElement) {
        var thisInstance = this;
        var params = form.serializeFormData();
    ...
    checkDuplicateRegionName(details) {
        var aDeferred = jQuery.Deferred();
        var params = {
            'module' : app.getModuleName(),
            'parent' : app.getParentModuleName(),
