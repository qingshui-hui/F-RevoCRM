 ...
 * All Rights Reserved.
 *************************************************************************************/
class Settings_Customer_Portal_Js extends Vtiger_Class_Js {
     ...
     */
    updatePortalModulesListByOrder() {
    ...
    registerUpdateSelectionEvent(latestselectedFields, currentModule) {
        var defaultFields = JSON.parse(jQuery('input[name="availableFields_'+currentModule+'"]').val());
    ...
    registerRelatedModuleInfoEvent(module) {
    ...
    registerEventForAddCustomModule() {
        var thisInstance = this;
    ...
    registerRecordPermissionsEvent() {
    ...
    registerEnableAddFieldsEvent(form, targetModule) {
        var thisInstance = this;
        if (form === undefined) {
    ...
    registerDisableAddFieldsEvent(form, targetModule) {
...
class Settings_CustomerPortal_Index_Js extends Settings_Customer_Portal_Js {};