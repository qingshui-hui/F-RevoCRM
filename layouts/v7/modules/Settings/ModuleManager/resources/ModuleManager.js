...
class Settings_ModuleManager_List_Js extends Vtiger_Index_Js {
    ...
    registerEventsForImportFromZip(container) {
    ...
    registerEvents(e) {
        ...
        super.registerEvents(container);
