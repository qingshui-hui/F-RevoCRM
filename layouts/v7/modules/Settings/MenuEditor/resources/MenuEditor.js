 ...
 * All Rights Reserved.
 *************************************************************************************/
class Settings_Menu_Editor_Js {
    getContainer() {
        return jQuery('#listViewContent');
    }

    registerAddModule(container) {
    ...
    registerAddModulePreSaveEvents(data) {
        var self = this;
    ...
    registerRemoveModule(container) {
    ...
    saveSequence(moduleSequenceArray, appname, move) {
        var params = {
            module: app.getModuleName(),
            parent: app.getParentModuleName(),
            action: 'SaveAjax',
