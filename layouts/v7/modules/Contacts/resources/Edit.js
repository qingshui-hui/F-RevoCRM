 ...
 * All Rights Reserved.
 *************************************************************************************/
class Contacts_Edit_Js extends Vtiger_Edit_Js {
    ...
    */
     ...
     */
    copyAddressDetails(data, container) {
        var thisInstance = this;
     ...
     */
    copyAddress(swapMode, container) {
        var thisInstance = this;
     ...
     */
    registerEventForCopyingAddress(container) {
        var thisInstance = this;
        var swapMode;
