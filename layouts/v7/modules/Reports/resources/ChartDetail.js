...
class Reports_ChartDetail_Js extends Reports_Detail_Js {
    /**
     * Function used to display message when there is no data from the server
     */
    static displayNoDataMessage() {
    ...
    registerEventForChartGeneration() {
        var thisInstance = this;
        try {
    ...
    savePinToDashBoard(customParams) {
...
class Report_Piechart_Js extends Vtiger_Pie_Widget_Js {
    postInitializeCalls() {
        var thisInstance = this;
...
class Report_Verticalbarchart_Js extends Vtiger_Barchat_Widget_Js {
    postInitializeCalls() {
        var thisInstance = this;
        var clickThrough = jQuery('input[name=clickthrough]', this.getContainer()).val();
        if (clickThrough != '') {
...
class Report_Horizontalbarchart_Js extends Report_Verticalbarchart_Js {
    generateChartData() {
        if (Reports_ChartDetail_Js.isEmptyData()) {
            Reports_ChartDetail_Js.displayNoDataMessage();
            return false;
...
class Report_Linechart_Js extends Report_Verticalbarchart_Js {
    generateData() {
        if (Reports_ChartDetail_Js.isEmptyData()) {
            Reports_ChartDetail_Js.displayNoDataMessage();
            return false;
