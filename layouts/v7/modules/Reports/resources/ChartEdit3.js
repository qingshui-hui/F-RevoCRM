 ...
 * All Rights Reserved.
 *************************************************************************************/
class Reports_ChartEdit3_Js extends Reports_Edit3_Js {
    static registerFieldForChosen() {
        vtUtils.showSelect2ElementView(jQuery('#groupbyfield'));
        vtUtils.showSelect2ElementView(jQuery('#datafields'));
    }

    static initSelectValues() {
