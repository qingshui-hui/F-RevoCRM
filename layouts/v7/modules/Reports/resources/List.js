...
class Reports_List_Js extends Vtiger_List_Js {
     ...
     */
    registerDeleteFilterClickEvent() {
        var thisInstance = this;
        var listViewFilterBlock = this.getFilterBlock();
    ...
    showQuickPreviewForId(recordId) {
        var self = this;
        var params = {};
    ...
    savePinToDashboard(element, customParams) {
        var listInstance = Reports_List_Js.getInstance();
    ...
    registerEventForPinChartToDashboard() {
        var thisInstance = this;
