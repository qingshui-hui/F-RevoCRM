 ...
 * All Rights Reserved.
 *************************************************************************************/
class Reports_Edit1_Js extends Reports_Edit_Js {
     ...
     */
    intializeOperationMappingDetails() {
     ...
     */
    getRelatedModulesFromPrimaryModule(primaryModule) {
        return this.relatedModulesMapping[primaryModule];
    }

    loadRelatedModules(primaryModule) {
    ...
    registerPrimaryModuleChangeEvent() {
     ...
     */
    registerSelect2ElementForSecondaryModulesSelection() {
        var secondaryModulesContainer = this.getSecondaryModuleContainer();
     ...
     */
    registerEventForScheduledReprots() {
        var thisInstance = this;
