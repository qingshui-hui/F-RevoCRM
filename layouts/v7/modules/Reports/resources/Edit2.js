 ...
 * All Rights Reserved.
 *************************************************************************************/
class Reports_Edit2_Js extends Reports_Edit_Js {
     ...
     */
    registerSelect2ElementForReportColumns() {
        var selectElement = this.getReportsColumnsList();
     ...
     */
    registerLineItemCalculationLimit() {
        var thisInstance = this;
    ...
    displayLineItemFieldLimitationMessage() {
    ...
    registerLineItemCalculationLimitOnLoad() {
        var moduleCalculationFields = jQuery('.CalculationFields input[type="checkbox"]').not('[value^="cb:vtiger_inventoryproductrel"]');
