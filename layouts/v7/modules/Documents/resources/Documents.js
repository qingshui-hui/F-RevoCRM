...
class Documents_Index_Js extends Vtiger_Class_Js {
    static fileObj = false;
    static referenceCreateMode = false;
    static referenceFieldName = '';

    static getInstance() {
        return new Documents_Index_Js();
    }

    static uploadTo(service, parentId, relatedModule, referenceFieldName) {
    ...
    static createDocument(type, parentId, relatedModule, referenceFieldName) {
        var instance = Documents_Index_Js.getInstance();
        instance.detectReferenceCreateMode(referenceFieldName);
        instance.createDocument(type,parentId,relatedModule);
    }

    detectReferenceCreateMode(referenceFieldName) {
    ...
    isDocumentsSummaryWidgetAvailable() {
    ...
    registerFileDragDropEvent(container) {
        var self = this;
    ...
    registerFileHandlingEvents(container) {
    ...
    updateDirectoryMeta(folderId, tab, backwardNavigation) {
    ...
    registerActiveTabEvent(container) {
        var self = this;
    ...
    registerUploadDocumentEvents(container) {
        var self = this;
    ...
    showUploadToVtigerModal(parentId, relatedModule) {
        var self = this;
    ...
    registerCreateDocumentEvent(container) {
        var self = this;
    ...
    registerCreateDocumentModalEvents(container) {
        container.find('form').vtValidate();
    ...
    createDocument(type, parentId, relatedModule) {
        var self = this;
