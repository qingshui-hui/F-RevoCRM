...
class Documents_Edit_Js extends Vtiger_Edit_Js {
    static file = false;
    ...
    isFileLocationInternalType(fileLocationElement) {
    ...
    isFileLocationExternalType(fileLocationElement) {
    ...
    registerFileLocationTypeChangeEvent(container) {
     ...
     */
    registerEventForCkEditor(container) {
    ...
    documentsQuickCreateConfig(container) {
        var form = this.getForm();
    ...
    handleDragDropEvents(container) {
        var thisInstance = this;
    ...
    registerCustomValidationForFileElement(container) {
         var thisInstance = this;
