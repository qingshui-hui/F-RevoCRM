...
class Documents_Detail_Js extends Vtiger_Detail_Js {
    //It stores the CheckFileIntegrity response data
    static checkFileIntegrityResponseCache = {};

    /*
     * function to trigger CheckFileIntegrity action
     * @param: CheckFileIntegrity url.
     */
    static checkFileIntegrity(checkFileIntegrityUrl) {
    ...
    /*
      ...
      */
    static getFileIntegrityResponse(params) {
     ...
     */
    static displayCheckFileIntegrityResponse(data) {
        var result = data;
    ...
    static triggerSendEmail(recordIds) {
        var params = {
            "module" : "Documents",
            "view" : "ComposeEmail",
