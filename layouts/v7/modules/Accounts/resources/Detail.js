...
class Accounts_Detail_Js extends Vtiger_Detail_Js {
    //It stores the Account Hierarchy response data
    static accountHierarchyResponseCache = {};

    /*
     * function to trigger Account Hierarchy action
     * @param: Account Hierarchy Url.
     */
    static triggerAccountHierarchy(accountHierarchyUrl) {
     ...
     */
    static getAccountHierarchyResponseData(url) {
     ...
     */
    static displayAccountHierarchyResponseData(data) {
