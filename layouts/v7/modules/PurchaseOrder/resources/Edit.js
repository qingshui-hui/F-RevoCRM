...
class PurchaseOrder_Edit_Js extends Inventory_Edit_Js {
    ...
    copyAddressFields(addressType, targetType) {
        var form = this.getForm();
    ...
    registerSwapAddress(selectedElement) {
    ...
    registerReferenceSelectionEvent(container) { 
        super.registerReferenceSelectionEvent(container); 
        var self = this; 
