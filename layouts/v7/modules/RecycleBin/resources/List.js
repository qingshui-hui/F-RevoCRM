...
class RecycleBin_List_Js extends Vtiger_List_Js {
    static recordSelectTrackerInstance = false;

    static emptyRecycleBin(url) {
    ...
    static restoreAction(recordId, restoreExternalFile) {
     ...
     */
    recycleBinActionPostOperations(data) {
     ...
     */
    registerRestoreRecordClickEvent() {
        var listViewContentDiv = this.getListViewContainer();
