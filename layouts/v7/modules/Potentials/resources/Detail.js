...
class Potentials_Detail_Js extends Vtiger_Detail_Js {
     ...
     */
    static convertPotential(convertPotentialUrl, buttonElement) {
     ...
     */
    disableConvertPotentialButton(button) {
     ...
     */
    enableConvertPotentialButton(button) {
     ...
     */
    displayConvertPotentialModel(data, buttonElement) {
        var instance = this;
     ...
     */
    registerConvertPotentialEvents() {
        var container = this.getConvertPotentialContainer();
        var instance = this;
     ...
     */
    registerConvertPotentialSubmit() {
