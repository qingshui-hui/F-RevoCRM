...
class SalesOrder_Edit_Js extends Inventory_Edit_Js {
    /**
     ...
     */
    registerEventForEnablingRecurrence() {
    ...
    AddOrRemoveRequiredValidation(dependentFieldsForValidation, addValidation) {
