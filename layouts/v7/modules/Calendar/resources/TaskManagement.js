...
class Vtiger_TaskManagement_Js extends Vtiger_Index_Js {
    ...
    saveFieldValue(recordId, fieldNameValueMap) {
    ...
    fillPopoverFieldValues(form, data) {
    ...
    registerSubjectFieldEnterEvent() {
        var thisInstance = this;
        var overlay = this.getOverlayContainer();
    ...
    registerEditedTaskCancelEvent(e) {
        var overlay = this.getOverlayContainer();
    ...
    registerParentModuleChangeEvent(e) {
        var overlay = this.getOverlayContainer();
