...
class Vtiger_Helper_Js {
    static checkServerConfigResponseCache = '';

    /*
     * Function to get the instance of Mass edit of Email
     */
    static getEmailMassEditInstance() {
    ...
    static requestToShowComposeEmailForm(selectedId, fieldname, fieldmodule) {
     ...
     */
    static getInternalMailer(selectedId, fieldname, fieldmodule) {
        var module = 'Emails';
    ...
    registerPostOverLayPageContentHideEvent() {
        var self = this;
     ...
     * @return date object
     */
    getDateInstance(dateTime, dateFormat, fieldType) {
    ...
    showHorizontalScroll(element, options) {
    ...
    showVerticalScroll(element, options) {
        if(typeof options == 'undefined') {
            options = {};
        }
        var params = {
    ...
    showBothAxisScroll(element, options) {
        if(typeof options == 'undefined') {
            options = {};
        }
    ...
    loadPageContentOverlay(data, params) {
        var aDeferred = new jQuery.Deferred();
        var defaultParams = this.defaultModalParams();
        params = jQuery.extend(defaultParams,params);
    ...
    loadHelpPageOverlay(data, params) {
        var aDeferred = new jQuery.Deferred();
        var defaultParams = this.defaultModalParams();
    ...
    getSelect2FromSelect(selectEle) {
   ...
   */
    ...
    showAlertNotification(options, settings) {
    ...
    showErrorNotification(options, settings) {
        var defaultOptions = {
    ...
    showSuccessNotification(options, settings) {
        var defaultOptions = {
    ...
    array_search(needle, haystack, argStrict) {
     ...
     */
    showConfirmationForRepeatEvents(customParams) {
        var self = this;
        var aDeferred = jQuery.Deferred();
        if(typeof customParams === 'undefined') {
            customParams = {};
    ...
    fixedBottomListViewScroll(scrollwrap) {
    ...
    dynamicListViewHorizontalScroll() {
    ...
    dynamicPopupViewHorizontalScroll() {
        var thisInstance = this;
    ...
    registerLeavePageWithoutSubmit(form) {
    ...
    registerModalDismissWithoutSubmit(form) {
        var initialFormData = form.serialize();
